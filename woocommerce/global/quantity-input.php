...
<div class="col-xs-6 noPadd">
	...
	<div class="col-sm-2 noPadd">
	 <button type="button" class="plus btn btn-default btn-number" data-type="plus" field="quantity">
                  <i class="fa fa-plus" aria-hidden="true"></i>
              </button>
               <button type="button" class="minus btn btn-default btn-number" field="quantity">
